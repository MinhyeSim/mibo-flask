...
class CalcModel:
    ...
    def calc(self, num1,num2, opcode):
        ...
        with tf.Session() as sess:
            ...
            graph = tf.get_default_grapgh()
            w1 = graph.get_tensor_by_name('w1:0') #외부에서 주입된 값
    ...
    def create_add_model(self):
        ...
        print(f"feed_dic['w1'] : {feed_dict['w1']}")
        print(f"feed_dic['w2'] : {feed_dict['w2']}")
        result = sess.run(r,{w1: feed_dict['w1'], w2: feed_dict['w1']})
